...
Although it is not specified in the original article, columns in the numerical table eff_hopping_ver2.dat ([Supplementary Materials](doi.org/10.1103/PhysRevX.8.031087) and here) mean, respectively: indexes $(m,n)$ of the real-space lattice vector of TBG, initial and final orbitals $(i,j)$ of a hopping, real and imaginary components of a $\xi = +$ valley hopping integral $t$. Do not mistake these $(m,n)$ vector indexes with the $(m,n)$ used to calculate commensurate angles, particularly $m=32,n=31$ ($\theta = 1.05$°).
